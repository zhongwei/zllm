...
### 14.3.2 温度采样 temperature sampling ⭐
...
### 14.3.4 top-p 采样（nucleus sampling）⭐
...
### 14.3.6 重复惩罚 repetition penalty（简述）
...
### 14.4.1 温度如何改变分布尖锐度（回引 Ch 03/05 的熵） ⭐⭐
